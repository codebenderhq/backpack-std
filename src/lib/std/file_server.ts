 ...
 * ```shell
 * > # start server
 * > deno run --allow-net --allow-read @std/http/file_server
 * > # show help
 * > deno run --allow-net --allow-read @std/http/file_server --help
 * ```
 *
 ...
 * ```shell
 * > # install
 * > deno install --allow-net --allow-read @std/http/file_server
 * > # start server
 * > file_server
 * > # show help
 * > file_server --help
...
import { join as posixJoin } from "jsr:/@std/path@^0.216.0/posix/join";
import { normalize as posixNormalize } from "jsr:/@std/path@^0.216.0/posix/normalize";
import { extname } from "jsr:/@std/path@^0.216.0/extname";
import { join } from "jsr:/@std/path@^0.216.0/join";
import { relative } from "jsr:/@std/path@^0.216.0/relative";
import { SEPARATOR_PATTERN } from "jsr:/@std/path@^0.216.0/constants";
import { contentType } from "jsr:/@std/media-types@^0.216.0/content_type";
...
import { ByteSliceStream } from "jsr:/@std/streams@^0.216.0/byte_slice_stream";
import { red } from "jsr:/@std/fmt@^0.216.0/colors";
import { format as formatBytes } from "jsr:/@std/fmt@^0.216.0/bytes";
